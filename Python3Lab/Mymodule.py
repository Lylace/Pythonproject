...
from random import randint   #모듈명으로 줄여쓰기
# import math
...
#모듈 호출 시 이름을 별칭으로 바꿔 정의
#import 모듈이름 as 별칭


#함수 호출 시 모듈명까지 기술하는 것은 왠지 불편
#from 모듈명 import 함수명
...
#한편, python IDEL 또는 다른 프로젝트에서 모듈을 참조하려면
#pathonPath가 정의한 위치에 모듈을 저장해야함(파이썬설치위치 or lib(내부))

lylacemodule.isLeapYear()
...
# import lylace.hello
from lylace.hello import sayHello
